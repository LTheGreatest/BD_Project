...
CREATE TABLE Films(
    ...
    FOREIGN KEY(film_id) REFERENCES Films_and_Series(film_or_series_id) ON DELETE CASCADE
);

DROP TABLE IF EXISTS Series;
CREATE TABLE Series(
    series_id INTEGER PRIMARY KEY,
    FOREIGN KEY(series_id) REFERENCES Films_and_Series(film_or_series_id) ON DELETE CASCADE
);
...
CREATE TABLE Actors(
    ...
    FOREIGN KEY(actor_id) REFERENCES Film_and_Series_Cast(cast_id) ON DELETE CASCADE
);

DROP TABLE IF EXISTS Directors;
CREATE TABLE Directors(
    director_id INTEGER PRIMARY KEY,
    FOREIGN KEY(director_id) REFERENCES Film_and_Series_Cast(cast_id) ON DELETE CASCADE
);
...
CREATE TABLE Actor_Participations(
    ...
    FOREIGN KEY(film_or_series_id) REFERENCES Films_and_Series(film_or_series_id) ON DELETE CASCADE
);
...
CREATE TABLE Favourites_Film_and_Series_Cast(
    ...
    FOREIGN KEY(username) REFERENCES Users(username) ON DELETE CASCADE,
    FOREIGN KEY(cast_id) REFERENCES Film_and_Series_Cast(cast_id) ON DELETE CASCADE
);
